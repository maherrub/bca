...
def inbox(request, template_name='django_messages/inbox.html'):
    ...
    out_list = Message.objects.outbox_for(request.user)
    return render_to_response(template_name, {
        'message_list': message_list, 'uprofile': uprofile, 'out_list': out_list,
...
def outbox(request, template_name='django_messages/outbox.html'):
    ...
    uprofile = UserProfile.objects.order_by('-created', 'firstname',)
    in_list = Message.objects.inbox_for(request.user)
    return render_to_response(template_name, {
        'message_list': message_list, 'uprofile': uprofile, 'in_list': in_list,
    }, context_instance=RequestContext(request))
...
def trash(request, template_name='django_messages/trash.html'):
    ...
    uprofile = UserProfile.objects.order_by('-created', 'firstname',)
    return render_to_response(template_name, {
        'message_list': message_list, 'uprofile': uprofile,
    }, context_instance=RequestContext(request))
