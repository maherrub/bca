...
class MessageAdmin(admin.ModelAdmin):
    ...
    list_display = ('pk', 'subject', 'sender', 'recipient', 'sent_at', 'read_at', 'sender_deleted_at', 'recipient_deleted_at', 'parent_msg')
    list_filter = ('sent_at', 'sender', 'recipient', 'sender_deleted_at', 'recipient_deleted_at',)
